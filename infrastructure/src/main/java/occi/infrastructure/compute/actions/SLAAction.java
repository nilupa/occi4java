...
public class SLAAction extends Action {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(SLAAction.class);
	 ...
	 */
	public enum Sla implements Method {
		sla;
	}

	@Override
	public void execute(URI uri, Method method) {
		LOGGER.debug("libvirt: sla");
		...
		computeInterface.setSLACompute(compute);
