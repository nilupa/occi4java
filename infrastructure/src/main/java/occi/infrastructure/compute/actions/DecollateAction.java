...
public class DecollateAction extends Action {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(DecollateAction.class);
	 ...
	 */
	public enum DeCollate implements Method {
		decollate
	}

	@Override
	public void execute(URI uri, Method method) {
		LOGGER.debug("libvirt: decollate");
		...
		computeInterface.makeDecollateCompute(compute);
